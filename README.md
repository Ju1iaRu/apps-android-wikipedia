...
All documentation is kept on [our wiki](https://www.mediawiki.org/wiki/Wikimedia_Apps/Team/Android/App_hacking).

### UI tests
You can see in the folder /app/src/androidTest/java/org/wikipedia/main
